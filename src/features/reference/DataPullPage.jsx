...
const columns = [
  ...
  { key: 'technicianType', header: 'Technician type', render: (r) => r.technicianType || '—' },
  ...
  return (
    <div>
      ...
      <div className="text-xs text-dark-400 mb-3">
        Technician type, chemical/supply cost and status date come from external sources (EnviroMaster Store / Bigin) not yet connected — shown as “—”. Service phase is derived from frequency (recurring vs one-time).
      </div>
